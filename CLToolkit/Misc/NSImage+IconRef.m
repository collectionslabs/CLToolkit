...
-(Handle) get32BitDataAtPixelSize:(int)requiredPixelSize
{
    ...
    if (bitsPerSample != 8)
	{
		NSLog(@"get32BitDataAtPixelSize: returning NULL due to bitsPerSample == %ld", bitsPerSample);
		return NULL;
	}
	...
	{
		NSLog(@"get32BitDataAtPixelSize: returning NULL due to samplesPerPixel == %ld, bitsPerPixel == %ld", samplesPerPixel, bitsPerPixel);
		return NULL;
	}
